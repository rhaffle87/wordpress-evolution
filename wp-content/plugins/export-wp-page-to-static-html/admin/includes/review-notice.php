...
function ewpptsh_wp_plugin_admin_notice() {
    ...
    if ( ($reviewStatus!=="done"&&$reviewStatus!=="hide")&&( ($reviewStatus=="later" && $reviewStatus!=="" && $dateToCheck < $sevenDaysAgo)) || ($reviewStatus=="" && $activation_date < $sevenDaysAgo)) {
        ...
        $notice_html = '<div class="export-html-review-notice2 notice notice-success" style="">
               <p style="font-size: 18px;"></p><h2 style="margin: 0" class="title">' . esc_html('You have been using "Export WP Pages to Static HTML" plugin for a while now. Thank you!', 'export-wp-page-to-static-html') . ' 💕 </h2><p>' . esc_html('If you have a minute, can you write a <b><a target="_blank" href="https://wordpress.org/support/plugin/export-wp-page-to-static-html/reviews/?rate=5#new-post">little review</a></b> for me? That would <b>really</b> bring me joy and motivation! 💫 <br>Don\'t hesitate to <b>share your feature requests</b> with the review, I always check them and try my best.', 'export-wp-page-to-static-html') . '</p>                                        
               <div style="padding: 5px 0 12px 0;display: flex;align-items: center"><a target="_blank" class="button button-primary" style="margin-right: 10px" href="https://wordpress.org/support/plugin/export-wp-page-to-static-html/reviews/?rate=5#new-post">
                    ✏️ '. esc_html('Write Review', 'export-wp-page-to-static-html') .'</a>
                    <button id="submit-review-done2" class="button button-secondary" style="margin-right: 10px;"> ✌️ '. esc_html('Done!', 'export-wp-page-to-static-html') . '</button>
                    <div style="flex: auto"></div>
                    <button id="submit-remind-later2" class="button button-secondary" style="margin-right: 10px;">⏰ ' . esc_html('Remind me later', 'export-wp-page-to-static-html') . '</button>
                    <button id="submit-hide2" class="button-link">' .esc_html('Hide', 'export-wp-page-to-static-html') . '</button>
