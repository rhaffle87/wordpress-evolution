<div class="tab-pane custom_links" id="tabs-2" role="tabpanel">
    ...
    <div class="customLinkSection blur">
        ...
        <div class="p-t-10">
            <label class="checkbox-container m-r-45" for="custom_url_skip_assets"><?php esc_html_e('Skip Assets (Css, Js, Images or Videos)', 'export-wp-page-to-static-html'); ?>
            ...
            <div class="skip_assets_subsection export_html_sub_settings">
                <label class="checkbox-container m-r-45" for="custom_url_skip_stylesheets"><?php esc_html_e('Skip Stylesheets (.css)', 'export-wp-page-to-static-html'); ?>
                    <input type="checkbox" id="custom_url_skip_stylesheets" name="custom_url_skip_stylesheets" checked>
                    <span class="checkmark"></span>
                </label>

                <label class="checkbox-container m-r-45" for="custom_url_skip_scripts"><?php esc_html_e('Skip Scripts (.js)', 'export-wp-page-to-static-html'); ?>
                    <input type="checkbox" id="custom_url_skip_scripts" name="custom_url_skip_scripts" checked>
                    <span class="checkmark"></span>
                </label>

                <label class="checkbox-container m-r-45" for="custom_url_skip_images"><?php esc_html_e('Skip Images', 'export-wp-page-to-static-html'); ?>
                    <input type="checkbox" id="custom_url_skip_images" name="custom_url_skip_images" checked>
                    <span class="checkmark"></span>
                </label>

                <label class="checkbox-container m-r-45" for="custom_url_skip_videos"><?php esc_html_e('Skip Videos', 'export-wp-page-to-static-html'); ?>
                    <input type="checkbox" id="custom_url_skip_videos" name="custom_url_skip_videos" checked>
                    <span class="checkmark"></span>
                </label>


                <label class="checkbox-container m-r-45" for="custom_url_skip_audios"><?php esc_html_e('Skip Audios', 'export-wp-page-to-static-html'); ?>
                    <input type="checkbox" id="custom_url_skip_audios" name="custom_url_skip_audios" checked>
                    <span class="checkmark"></span>
                </label>

                <label class="checkbox-container m-r-45" for="custom_url_skip_docs"><?php esc_html_e('Skip Documents', 'export-wp-page-to-static-html'); ?>
        ...
        <div class="p-t-10">
            ...
            <div class="ftp_Settings_section2 export_html_sub_settings">
                ...
                <!--  <div class="ftp_settings_item">
                                                <input type="text" id="ftp_host2" name="ftp_host" placeholder="Host" value="<?php echo esc_html($host); ?>">
                                            </div>
                                            <div class="ftp_settings_item">
                                                <input type="text" id="ftp_user2" name="ftp_user" placeholder="User" value="<?php echo esc_html($user); ?>">
                                            </div>
                                            <div class="ftp_settings_item">
                                                <input type="password" id="ftp_pass2" name="ftp_pass" placeholder="Password" value="<?php echo esc_html($pass); ?>">
                                            </div> -->
                <div class="ftp_settings_item">
                    <label for="ftp_path2">FTP upload path</label>
                    <input type="text" id="ftp_path2" name="ftp_path" placeholder="Upload path" value="<?php echo esc_html($path); ?>">
        ...
        <div class="p-t-10">
            <div class="email_settings_section">
                ...
                <div class="email_settings_item">
                    <input type="text" id="receive_notificationesc_html_email2" name="notificationesc_html_email" placeholder="Enter emails (optional)">
        ...
        <button class="btn btn--radius-2 btn--blue exportesc_html_external_page_to_html" type="submit"><?php esc_html_e('Export HTML', 'export-wp-page-to-static-html'); ?> <span class="spinner_x hide_spin"></span></button>
        <a class="cancel_rc_htmlesc_html_export_process" href="#">
            Cancel
        </a>
        <a href="" class="btn btn--radius-2 btn--green download-btn hide" type="submit"><?php esc_html_e('Download the file', 'export-wp-page-to-static-html'); ?></a>
        <a href="" class="viewesc_html_exported_file hide" type="submit" target="_blank"><?php esc_html_e('View Exported File', 'export-wp-page-to-static-html'); ?></a>
