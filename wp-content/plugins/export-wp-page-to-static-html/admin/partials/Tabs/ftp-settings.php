...
<div class="tab-pane" id="tabs-4" role="tabpanel">
    <div class="ftp_Settings_section3 blur">
        ...
        <div class="ftp_settings_item">
            ...
            <input type="text" id="ftp_host3" name="ftp_host" placeholder="Host" value="<?php esc_html($host); ?>">
        </div>
        <div class="ftp_settings_item">
            <label for="ftp_user3">FTP user</label>
            <input type="text" id="ftp_user3" name="ftp_user" placeholder="User" value="<?php esc_html($user); ?>">
        </div>
        <div class="ftp_settings_item">
            <label for="ftp_pass3">FTP password</label>
            <input type="password" id="ftp_pass3" name="ftp_pass" placeholder="Password" value="<?php esc_html($pass); ?>">
        </div>
        <div class="ftp_settings_item">
            <label for="ftp_path3">FTP upload path (deafult)</label>
            <input type="text" id="ftp_path3" name="ftp_path" placeholder="Upload path" value="<?php esc_html($path); ?>">
        </div>
